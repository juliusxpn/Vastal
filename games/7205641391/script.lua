...
local key_maps = {
    ...
    ["6K"] = {
        order = {"Left", "Down", "Up", "Right", "UpLeft", "UpRight"},
        keys = {
            Left = Enum.KeyCode.S,
            Down = Enum.KeyCode.D,
            Up = Enum.KeyCode.F,
            UpLeft = Enum.KeyCode.J,
            UpRight = Enum.KeyCode.K,
    ...
    ["7K"] = {
        order = {"Left", "Down", "Up", "Space", "Left2", "Down2", "Up2"},
        keys = {
            Left = Enum.KeyCode.S,
            Down = Enum.KeyCode.D,
            Up = Enum.KeyCode.F,
    ...
    ["9K"] = {
        order = {"Key1", "Key2", "Key3", "Key4", "Space", "Key5", "Key6", "Key7", "Key8"},
        keys = {
            Key1 = Enum.KeyCode.A,
            Key2 = Enum.KeyCode.S,
            Key3 = Enum.KeyCode.D,
...
shared.__AUTOPLAYER = rs.Heartbeat:Connect(function()
    ...
    if not key_maps[mode] then return end
